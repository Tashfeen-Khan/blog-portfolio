  ...
  return (
      ...
      <div className= "bg-primary-Bg about-me container mx-auto py-2 ">
        <div className="section-title text-primary-Text  flex flex-col px-8 sm:px-16  items-center">
          <h2 className="font-medium text-light-Secondary ">About</h2>
          <p className="text-4xl  font-extrabold md:text-5xl text-light-Secondary">
            Learn more about me
          </p>
        </div>
        ...
        <div className=" grid grid-cols-1 lg:grid-cols-2 items-center  ">
          ...
          <div className=" px-2 sm:px-0 lg:col-span-1 pt-4 ">
            <h3 className="text-2xl text-light-Primary ">
              {data.workField}
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  gap-1 text-primary-Text">
              <div className=" w-full ">
                <ul className="">
                  <li className="flex  my-2 gap-1">
                    <IoIosArrowForward className=" text-light-Accent  text-xl" />{" "}
              ...
              <div className=" w-full ">
                <ul>
                  ...
                  <li className="flex items-center py-2 gap-1 ">
                    <IoIosArrowForward className="  text-light-Accent text-xl flex flex-wrap" />{" "}

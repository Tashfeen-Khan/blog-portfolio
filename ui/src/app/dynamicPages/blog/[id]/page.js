      ...
      <div className="bg-light-Bg dark:bg-dark-bg">
        <header className="p-4  flex justify-center">
          <div className="w-full md:w-3/5  ">
            ...
            <h1 className="text-4xl font-bold py-2 text-light-H_black dark:text-dark-text">{blog.title}</h1>
            <p className="text-light-Text">{blog.content}</p>

            <p className="w-full border-b py-4 border-x-light-H_blue dark:border-x-dark-icon_bg "></p>
            <div className="grid sm:grid-cols-2 justify-between ">
              <div className="flex">
                ...
                <div className="flex pl-4 flex-col justify-center">
                  <h5 className="font-bold text-light-H_black dark:text-dark-text">
                    Foulcher Nathanil
                  </h5>
                  <p className="font-lights text-sm  text-light-Text">{`${blog.status} at ${formattedDate}`}</p>
                </div>
              </div>
              <div className="flex py-4 gap-2 sm:justify-end">
                <Like/>
                {/* <div className="text-xl flex justify-center items-center text-center hover:bg-pink-200 hover:text-pink-700 w-20 font-light rounded-full">
                  <IoIosHeartEmpty />
                  {blog.meta.likes}
                </div> */}
                <p className="w-4 border-r border-neutral-200"></p>
                <Share/>
                {/* <p className="text-2xl flex justify-center items-center bg-neutral-200 w-8 rounded-full sm:w-12">
                  <GoShareAndroid />
                </p> */}
              </div>
            </div>
        ...
        <container className="flex justify-center">
          <div className="p-4 md:w-3/4">
            ...
            <div className="mt-4">
              <p className="text-lg text-light-Text">{blog.content}</p>
            </div>
          </div>
        </container>
      </div>

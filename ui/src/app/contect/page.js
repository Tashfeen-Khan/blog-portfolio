...
const page = () => {
  ...
  <div className=" px-5  flex justify-center" style={{ height: '50vh' }}>
  ...
  <h2 className="text-light-H_blue text-2xl mb-1 font-medium title-font">Feedback</h2>
  <p className="leading-relaxed mb-5 text-light-Text">Post-ironic portland shabby chic echo park, banjo fashion axe</p>
        </div>
        <div>
  ...
  <BasicBtn title="Send Message"/>
            ...
            <img src="/images/ContactUs.png" alt="Contact Us" className='w-full ' />

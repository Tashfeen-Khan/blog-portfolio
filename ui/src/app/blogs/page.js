...
<div className="container px-5 py-24 mx-auto">
  <div className="flex flex-wrap -m-4">
    ...
    {blogs.map(blog => (
         ...
         <img className="w-full object-cover object-center" src={blog.image} alt={blog.title} />

           <div className="p-6">
             <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">{blog.title}</h2>
             <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{blog.author}</h1>
